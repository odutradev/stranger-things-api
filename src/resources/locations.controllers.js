...
import UtilLocations from "../util/locations.js";
import { sendError } from "../app.js";

const { didYouMean, checkSimilarity } = new StringSimilarity();
const { getFile, sendLocation } = new UtilLocations();
...
export default class LocationsController {
  ...
  async getLocations(req, res) {
    ...
    if (locations.length < start)
      return sendError(res, "location_limit", locations.length);
    locations = [];
